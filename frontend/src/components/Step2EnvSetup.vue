    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, automatically calls tools to organize entities and relations from the knowledge graph, initializes simulation individuals, and assigns them unique behaviors and memories based on reality seeds.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently configures world time flow, recommendation algorithms, active hours per individual, posting frequency, event triggers, and more based on simulation requirements and reality seeds.
          </p>
      ...
      <div class="step-card" :class="{ ‘active’: phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Round count config - only shown after config is generated and rounds are computed -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Round Settings</span>
                <span class="section-desc">MiroFish auto-plans simulation of <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || ‘-’ }}</span> real-world hours; each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || ‘-’ }}</span> real minutes.</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For first-time runs, it is strongly recommended to switch to ‘Custom Mode’ to reduce round count for a quick preview and lower error risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
...
// Compute total associated topics across all personas
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only update if API returns valid value, avoid overwriting existing valid values
