...
// Fetch maxRounds from query params at init time so child components receive the value immediately
...
const startGraphRefresh = () => {
  ...
  addLog('Graph auto-refresh enabled (30s interval)')
...
onMounted(() => {
  ...
  // Log maxRounds config (value already fetched from query params at init)
  if (maxRounds.value) {
