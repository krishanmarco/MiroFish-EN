...
For persisting project state on server side, avoid passing large amounts of data between frontend interfaces
"""
...
class ProjectManager:
    """Project manager - responsible for project persistent storage and retrieval"""
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get project extract storage path"""
