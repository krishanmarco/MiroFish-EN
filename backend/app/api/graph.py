...
Implements project context mechanism with server-side state persistence
"""
...
def generate_ontology():
    ...
    """
    try:
        logger.info("=== Starting to generate ontology definition ===")
...
def build_graph():
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is currently being built, do not resubmit. To force rebuild, add force: true",
