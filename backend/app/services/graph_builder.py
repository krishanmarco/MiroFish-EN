...
class GraphBuilderService:
    """
    Graph Building Service
    Responsible for building knowledge graph using Zep API
    """
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by Zep SDK, warning comes from dynamic class creation, can be safely ignored
        warnings.filterwarnings('ignore', category=UserWarning, module='pydantic')

        # Zep reserved names that cannot be used as property names
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            # Create attributes dict and type annotations (required for Pydantic v2)
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API requires Field description, this is required
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  # Edge attributes use string type
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges with detailed data including time info and attributes
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
